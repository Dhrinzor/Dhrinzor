...
class Build_Zone_Work(ft.UserControl):
    ...
    ######EXTRAS###########################
    # def Buil_Categorias(self): # Aseguramos que la referencia a la página esté disponible
    #     data_almacen= ft.Container(
    #                         content=self.menu_almacen.build_zone_categorias(),
    #                         border_radius=15,
    #                         expand=True,
    #                         bgcolor=ft.colors.BLACK12,  # Asegurarse que el contenedor esté visible
    #                     ) 
    #     return ft.Row(
    #                 expand=True,
    #                 controls=[data_almacen,
    #                 ],
    #             )
    #     ######ALMACEN###########################
    # def Buil_Categorias(self): # Aseguramos que la referencia a la página esté disponible
