...
class PageContent:
    ...
    def _handle_start_button(self, e):
        ...
        if hasattr(self.app, "actualizar_checkboxes"):
            print("Actualizando checkbox de bienvenida...")
            self.app._update_checkboxes("Welcome")  # Se asegura que se active el checkbox adecuado
        else:
            print("Error: El método 'actualizar_checkboxes' no está disponible en 'app'.")
        
        # Navegar a la página License.py
        print("Navegando a la página de Licencias...")
